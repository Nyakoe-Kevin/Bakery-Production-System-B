...
export const useProductStore = defineStore('product', () => {
    ...
    const products = ref([
        { id: 1, name: 'White Bread', category: 'bread', selling_price: 60, shelf_life_hours: 24, unit: 'loaf', available_stock: 120, is_active: true },
        { id: 2, name: 'Chocolate Cake', category: 'cake', selling_price: 350, shelf_life_hours: 72, unit: 'piece', available_stock: 16, is_active: true },
        { id: 3, name: 'Cinnamon Roll', category: 'pastry', selling_price: 40, shelf_life_hours: 12, unit: 'piece', available_stock: 42, is_active: true },
        { id: 4, name: 'Mandazi', category: 'bun', selling_price: 10, shelf_life_hours: 12, unit: 'piece', available_stock: 80, is_active: true },
        { id: 5, name: 'Brown Bread', category: 'bread', selling_price: 65, shelf_life_hours: 24, unit: 'loaf', available_stock: 90, is_active: true },
        { id: 6, name: 'Meat Pie', category: 'pastry', selling_price: 80, shelf_life_hours: 8, unit: 'piece', available_stock: 14, is_active: true },
        { id: 7, name: 'Chapati', category: 'bread', selling_price: 20, shelf_life_hours: 8, unit: 'piece', available_stock: 72, is_active: true },
    ])
